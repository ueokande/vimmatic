...
test.fixme('should all tabs by "buffer" command with empty params', async ({
  page,
  api,
}) => {
  await setupTabs(api);
...
test.fixme('should filter items with URLs by keywords on "buffer" command', async ({
  page,
  api,
}) => {
  await setupTabs(api);
...
test.fixme('should filter items with titles by keywords on "buffer" command', async ({
  page,
  api,
}) => {
  await setupTabs(api);
...
test.fixme('should show one item by number on "buffer" command', async ({
  page,
  api,
}) => {
  await setupTabs(api);
...
test.fixme('should show only unpinned tabs "bdelete" command', async ({
  page,
  api,
}) => {
  await setupTabs(api);
...
test.fixme('should show only unpinned tabs "bdeletes" command', async ({
  page,
  api,
}) => {
  await setupTabs(api);
...
test.fixme('should show both pinned and unpinned tabs "bdelete!" command', async ({
  page,
  api,
}) => {
  await setupTabs(api);
...
test.fixme('should show both pinned and unpinned tabs "bdeletes!" command', async ({
  page,
  api,
}) => {
  await setupTabs(api);
